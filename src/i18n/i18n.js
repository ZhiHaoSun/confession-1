...
const translations = {
  zh: {
    ...
    puzzles: {
      ...
      jigsawDesc: '这一幕会变成 2×2 的四块拖拽拼图，不会显示发光点击点；她拼对全部 4 块后即可通关。',
      herBirthday: '她的生日',
      anniversary: '纪念日',
    },
    ...
    game: {
      ...
      jigsawInstruction: '拖动 4 块拼图到正确位置',
      jigsawTray: '从这里拖动拼图块',
  ...
  en: {
    ...
    puzzles: {
      ...
      jigsawDesc: 'This scene becomes a 2×2 draggable jigsaw puzzle with no glowing hotspots. She passes the chapter after all 4 pieces are placed correctly.',
      herBirthday: 'her birthday',
    ...
    game: {
      ...
      jigsawInstruction: 'Drag all 4 pieces into the right places',
